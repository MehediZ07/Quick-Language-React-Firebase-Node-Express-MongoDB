    ...
    <div className="w-full flex flex-col items-center justify-center mb-12">
      ...
      <div className="join join-vertical max-w-7xl w-full rounded-lg">
        ...
        <div className="collapse collapse-arrow join-item ">
          ...
          <div className="collapse-content border-b-4 solid border-[#acea80c7] rounded-xl rounded- ">
            <p>
        ...
        <div className="collapse collapse-arrow join-item ">
          ...
          <div className="collapse-content border-b-4 solid border-[#acea80c7] rounded-xl">
            <p>
